...
CREATE DATABASE IF NOT EXISTS sare_main_db CHARACTER SET utf8mb4 COLLATE utf8_unicode_ci;
GRANT ALL PRIVILEGES ON sare_main_db.* TO 'java_user'@'localhost';

CREATE DATABASE IF NOT EXISTS sare_webapp_db CHARACTER SET utf8mb4 COLLATE utf8_unicode_ci;
