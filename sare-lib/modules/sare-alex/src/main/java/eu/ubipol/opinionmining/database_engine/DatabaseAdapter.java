...
package eu.ubipol.opinionmining.database_engine;
...
public class DatabaseAdapter {
	...
	public AspectLexicon getAspect(String word) {
		AspectExpression expression = lexicon.findExpression(word, true);
		if (expression == null || expression.getAspect() == null) {
			return null;
		}

		return expression.getAspect();
	}
}