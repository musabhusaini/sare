...
object UuidUtils {
	 ...
	 * @return the {@link Function} for such conversion.
	 */
	def toUuidFunction[T <: IUniquelyIdentifiable]: Function[T, UUID] = {
		new Function[T, UUID] {
	 ...
	 * @return the {@link Function} for such conversion.
	 */
	def toUuidStringFunction[T <: IUniquelyIdentifiable]: Function[T, String] = {
	 ...
	 */
	def identifierEqualsPredicate[T <: IUniquelyIdentifiable](identifier: UUID): Predicate[T] = {
		new Predicate[T] {
